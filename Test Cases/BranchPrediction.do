# ==============================================================================
# ModelSim DO file for BranchPrediction Test Case
# ==============================================================================
# This script:
# 1. Runs the assembler on BranchPrediction.asm
...
puts "========================================"
puts "BranchPrediction Test Case Simulation"
puts "========================================"
...
puts "\n=== Running Assembler on BranchPrediction.asm ==="
exec python spec/assembler.py "Test Cases/BranchPrediction.asm" mem.txt
...
# Add PC and instruction - IMPORTANT for branch prediction
...
add wave -radix hexadecimal /Processor_Top/fetch_stage_inst/next_pc

# Add register file
add wave -divider "Register File"
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(0)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(1)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(2)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(3)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(4)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(5)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(7)
...
# Add CCR flags - IMPORTANT for conditional branches
...
# Add Control Signals - IMPORTANT for branch control
...
# Add Branch Prediction signals (if exists)
if {[info exists /Processor_Top/branch_predictor_inst]} {
    add wave -divider "Branch Prediction"
    add wave /Processor_Top/branch_predictor_inst/prediction
    add wave /Processor_Top/branch_predictor_inst/branch_taken
    add wave /Processor_Top/branch_predictor_inst/misprediction
}

# Add Hazard Detection signals (if exists) - IMPORTANT for control hazards
...
# Add IO Ports - to see loop outputs
if {[info exists /Processor_Top/output_port]} {
...
puts "\n=== Running Simulation ==="
puts "Running for 3000 ns (longer for loops)..."
run 3000 ns
...
puts "\n========================================"
puts "BranchPrediction Test Case Simulation Complete!"
puts "========================================"
puts "\nInstructions:"
puts "  - Use 'run <time>' to continue simulation"
puts "  - Use 'restart' to restart simulation"
puts "  - Examine waveforms in the Wave window"
puts "  - Check JMP and JZ instructions in loops"
puts "  - Verify branch prediction behavior (if implemented)"
puts "  - Check output port for loop iteration values"
puts "========================================"
