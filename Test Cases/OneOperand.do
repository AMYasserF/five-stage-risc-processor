# ==============================================================================
# ModelSim DO file for OneOperand Test Case
# ==============================================================================
# This script:
# 1. Runs the assembler on OneOperand.asm
...
puts "========================================"
puts "OneOperand Test Case Simulation"
puts "========================================"
...
puts "\n=== Running Assembler on OneOperand.asm ==="
exec python spec/assembler.py "Test Cases/OneOperand.asm" mem.txt
...
# Add register file - IMPORTANT for one-operand instructions
...
# Add IO Ports - IMPORTANT for IN/OUT
