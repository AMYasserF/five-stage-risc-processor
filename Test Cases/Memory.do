# ==============================================================================
# ModelSim DO file for Memory Test Case
# ==============================================================================
# This script:
# 1. Runs the assembler on Memory.asm
...
puts "========================================"
puts "Memory Test Case Simulation"
puts "========================================"
...
puts "\n=== Running Assembler on Memory.asm ==="
exec python spec/assembler.py "Test Cases/Memory.asm" mem.txt
...
# Add Memory signals - IMPORTANT for this test
...
# Add Stack Pointer - IMPORTANT for PUSH/POP
add wave -divider "Stack Pointer"
add wave -radix hexadecimal /Processor_Top/memory_stage_inst/sp_out

# Add Memory contents (specific addresses for this test)
add wave -divider "Memory Contents"
add wave -radix hexadecimal /Processor_Top/memory_inst/ram(16#3FFFF#)
add wave -radix hexadecimal /Processor_Top/memory_inst/ram(16#3FFFE#)
add wave -radix hexadecimal /Processor_Top/memory_inst/ram(16#3FFFD#)
add wave -radix hexadecimal /Processor_Top/memory_inst/ram(16#10200#)
add wave -radix hexadecimal /Processor_Top/memory_inst/ram(16#10201#)
add wave -radix hexadecimal /Processor_Top/memory_inst/ram(16#FFF5#)
