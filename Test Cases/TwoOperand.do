# ==============================================================================
# ModelSim DO file for TwoOperand Test Case
# ==============================================================================
# This script:
# 1. Runs the assembler on TwoOperand.asm
...
puts "========================================"
puts "TwoOperand Test Case Simulation"
puts "========================================"
...
puts "\n=== Running Assembler on TwoOperand.asm ==="
exec python spec/assembler.py "Test Cases/TwoOperand.asm" mem.txt
...
# Add register file - IMPORTANT for two-operand instructions
...
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(6)
add wave -radix hexadecimal /Processor_Top/decode_stage_inst/reg_file_inst/registers(7)

# Add ALU signals - IMPORTANT for ADD, SUB, AND operations
...
add wave /Processor_Top/decode_stage_inst/control_unit_inst/alu_src

# Add Forwarding signals (if exists) - IMPORTANT for data hazards
...
puts "\n========================================"
puts "TwoOperand Test Case Simulation Complete!"
puts "========================================"
puts "\nInstructions:"
puts "  - Use 'run <time>' to continue simulation"
puts "  - Use 'restart' to restart simulation"
puts "  - Examine waveforms in the Wave window"
puts "  - Check ADD, SUB, AND, SWAP, MOV operations"
puts "  - Verify data forwarding for dependent instructions"
puts "========================================"
