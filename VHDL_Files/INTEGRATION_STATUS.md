...
4. **ID_EX_register** - Pipeline register between Decode and Execute
   ...
   - Outputs: All signals to execute stage (idex\_\* prefix)
...
- alu_op → idex_alu_op
- All control signals now sourced from idex\_\* signals
...
5. **Implement Writeback Stage**
   ...
   - Connect wb*write*\* signals to decode stage register file
